            ...
            <div class="xl:pl-8">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <Tool-Tip message="Pdf" class="-mt-7 text-color-4">
                        <Icon v-if="auth.checkPermission('exportar pdf inscripciones curso')" @click="inscripciones.exportPdf(store.curso.id)" :icon="inscripciones.loading.pdf ? 'fas fa-spinner' : 'fas fa-file-pdf'" class="icon-button p-2 btn-danger" :class="inscripciones.loading.pdf ? 'animate-spin bg-gray-300 text-gray-500' : ''" :disabled="inscripciones.loading.pdf" />
                    </Tool-Tip>
                </div>
                <br>
