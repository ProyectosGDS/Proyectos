...
<template>
    <details :open="true" class="pb-4">
        ...
        <div class="grid lg:grid-cols-2 gap-4">
            <Input v-model="store.beneficiario.cui" option="label" title="*cui" maxlength="13" :error="store.errors.hasOwnProperty('cui')" required readonly disabled/>
            <Input v-model="store.beneficiario.pasaporte" option="label" title="pasaporte" maxlength="20" :error="store.errors.hasOwnProperty('pasaporte')" required />
            ...
            <Input v-model="store.beneficiario.estado_civil_id" option="select" title="seleccione estado civil" :error="store.errors.hasOwnProperty('estado_civil_id')">
                <option value=""></option>
                <option v-for="estado_civil in catalogos.catalogo.estados_civiles" :value="estado_civil.id">{{ estado_civil.nombre }}</option>
            </Input>
            ...
            <Input v-model="store.beneficiario.interlocutor" option="label" title="interlocutor" maxlength="10" :error="store.errors.hasOwnProperty('interlocutor')" readonly/>
        </div>
    </details>
</template>
