...
<template>
    <details class="border-t-2 py-4">
        ...
        <div class="grid lg:grid-cols-2 gap-4">
            ...
            <Input v-model="store.beneficiario.responsable.celular" option="label" title="*celular" type="tel" pattern="\d{8}" maxlength="8" :error="store.errors.hasOwnProperty('responsable.celular')"/>
