...
const props = defineProps({
    ...
    data: null,
    color: {
        default: 'bg-color-1 text-color-9'
    },
    loading: {
        type: Boolean,
        default: false
...
<template>
    <section class="px-4 lg:px-7">
        ...
        <div class="md:flex md:items-center md:justify-between">
            <div class="text-color-9 bg-transparent flex items-center px-2 py-1.5">
                <span>Mostrar</span>
            ...
            <div class="flex items-center gap-1">
                ...
                <div class="flex gap-1">
                    ...
                    <!-- END FILTER ADVANCE -->
                    <Tool-Tip message="Excel" class="-mt-7 text-color-9">
                    ...
                    <Tool-Tip message="Pdf" class="-mt-7 text-color-9">
            ...
            <template #thead>
                <tr>
                    ...
                    <th v-for="(head, index) in props.headers" 
                        ...
                        scope="col" 
                        class="px-4 py-3.5 text-color-9 text-xs cursor-pointer select-none" 
                        :width="head.width" 
                ...
                <div v-show="filteredData.length >= rowsPerPage && displayedPages.length > 1">
                    <nav class="flex gap-x-2">
                        <a v-if="currentPage > 4" @click="setCurrentPage(1)"
                            class="cursor-pointer relative flex items-center px-3 py-1.5 font-semibold text-color-9 rounded-full hover:bg-gray-200">
                            <Icon icon="fas fa-angles-left" class="text-xs" />
                        </a>
                        <a v-if="currentPage > 1" @click="(currentPage == 1) ? currentPage = 1 : currentPage--"
                            class="cursor-pointer relative flex items-center px-3 py-1.5 text-sm font-semibold text-color-9 rounded-full hover:bg-gray-200">
                        ...
                        <a :class="page === currentPage ? ' z-10 ' + props.color : ''"
                            ...
                            class="cursor-pointer select-none relative flex items-center px-3 py-1.5 text-color-9 text-sm font-semibold rounded-full hover:bg-gray-200 hover:text-color-9">
                            {{ page }}
                        </a>
